...
const GetStartedSection = () => {
  return (
    <div className="w-11/12 mx-auto 2xl:w-9/12 bg-primary text-white rounded-xl">
      <div className=" w-6/12 mx-auto flex flex-col items-center py-24 space-y-6">
        <h1 className="text-4xl leading-[60px] font-bold text-center">
          Starting with CMS is easy, fast and free
        </h1>
