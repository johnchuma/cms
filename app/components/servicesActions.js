        ...
        {show && (
          ...
          >
            {[
              {
                title: "Guests",
                path: `/dashboard/groups/services/guests/?uuid=${uuid}`,
                icon: <AiOutlineUser />,
              },
              {
                title: "Attendances",
                path: `/dashboard/groups/services/attendances/?uuid=${uuid}`,
                icon: <AiOutlineCalendar />,
              },
              {
                title: "Offerings",
                path: `/dashboard/groups/services/offerings/?uuid=${uuid}`,
                icon: <AiOutlineProduct />,
              },
              {
                title: "Edit Service",
                path: `/dashboard/groups/services/edit/${uuid}`,
                icon: <BiSolidEdit />,
              },
            ].map((item) => {
              return (
