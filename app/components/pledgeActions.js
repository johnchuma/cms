        ...
        {show && (
          ...
          >
            {[
              {
                title: "Contributions",
                path: `/dashboard/groups/projects/pledges/contributions/?uuid=${uuid}`,
                icon: <AiOutlineMoneyCollect />,
              },
              {
                title: "Edit Details",
                path: `/dashboard/groups/projects/pledges/edit/${uuid}`,
