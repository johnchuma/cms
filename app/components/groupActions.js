        ...
        {show && (
          ...
          >
            {[
              {
                title: "Members",
                path: `/dashboard/groups/members/?uuid=${uuid}`,
                icon: <AiOutlineUser />,
              },
              {
                title: "Projects",
                path: `/dashboard/groups/projects/?uuid=${uuid}`,
                icon: <AiOutlineSetting />,
              },
              {
                title: "Leaders",
                path: `/dashboard/groups/leaders/?uuid=${uuid}`,
                icon: <AiOutlineUserAdd />,
              },
              {
                title: "Services",
                path: `/dashboard/groups/services/?uuid=${uuid}`,
                icon: <PiHandsPrayingLight />,
              },
              {
                title: "Expenses",
                path: `/dashboard/groups/expenses/?uuid=${uuid}`,
                icon: <AiOutlineTable />,
              },
              {
                title: "Calender",
                path: `/dashboard/groups/calender/?uuid=${uuid}`,
                icon: <AiOutlineCalendar />,
              },
              {
                title: "Edit Group",
                path: `/dashboard/groups/edit/${uuid}`,
